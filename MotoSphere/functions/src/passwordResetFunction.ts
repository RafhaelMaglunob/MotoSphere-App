...
import { getDb, functions } from "../../Backend/firebase";
import { getUserCache, setUserCache } from "../../Backend/controller/cache/userCache";

/**
 * Generate a secure 6-digit reset code (easier for mobile input)
 */
